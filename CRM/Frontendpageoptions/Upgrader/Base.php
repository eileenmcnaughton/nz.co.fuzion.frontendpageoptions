 ...
 */
class CRM_Frontendpageoptions_Upgrader_Base {
  ...
  static public function instance() {
    if (!self::$instance) {
      // FIXME auto-generate
      self::$instance = new CRM_Frontendpageoptions_Upgrader(
   ...
   *
   * @code
   * CRM_Frontendpageoptions_Upgrader_Base::_queueAdapter($ctx, 'methodName', 'arg1', 'arg2');
   * @endcode
   */
